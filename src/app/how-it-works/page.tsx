  ...
  return (
    <PageLayout>
      <PageHeader className="bg-gradient-to-b from-teal-50 to-teal-100/30 dark:from-teal-950 dark:to-teal-900/20">
        <PageTitle className="text-teal-800 dark:text-teal-200">How Timeaway.ai Works</PageTitle>
      ...
      <PageContent className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
        <div className="max-w-4xl mx-auto space-y-10">
          <OptimizationExplainer
            introText="Timeaway.ai uses advanced planning strategies to help you get the most out of your limited PTO days. By strategically placing your days off around weekends, public holidays, and company days off, you can significantly increase your total time away from work."
