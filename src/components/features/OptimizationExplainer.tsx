      ...
      >
        <div className="space-y-4 pt-3 sm:space-y-6 sm:pt-4">
          ...
          <p className="text-sm leading-relaxed text-gray-700 dark:text-gray-300 sm:text-base tracking-normal">
            {introText || 'The key to maximizing your time off is strategic PTO placement. Of course, 15 PTO days can\'t magically become 53 days off - Timeaway.ai simply helps you align your PTO days around weekends and holidays to create longer stretches of consecutive time off work.'}
          </p>
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-[15px] text-teal-700 dark:text-teal-300 leading-relaxed">
                  Timeaway.ai doesn&apos;t add to your PTO days - it finds the most strategic placement for them. This
